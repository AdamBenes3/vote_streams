...
class stv_test(unittest.TestCase):
    ...
    def test_stv2(self):
        ...
        S = stv(candidates, votes)
        expected_output_1 = ["a", "b", "c", "d", "e"]  # Expected output dictionary
        self.assertEqual(S.stv(), expected_output_1)
    ...
    def test_stv3(self):
        ...
        S = stv(candidates, votes)
        expected_output_3 = [5, 2, 1, 4, 3]  # Expected output dictionary
    ...
    def test_stv4(self):
        ...
        S = stv(candidates, votes)
        expected_output_3 = [1, 2, 3]  # Expected output dictionary
        self.assertEqual(S.stv(), expected_output_3)
